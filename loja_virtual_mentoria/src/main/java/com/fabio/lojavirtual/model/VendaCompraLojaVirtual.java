package com.fabio.lojavirtual.model;
...
public class VendaCompraLojaVirtual implements Serializable {
	...
	public Date getDataEntreDate() {
		return dataEntreDate;
	}

	public void setDataEntreDate(Date dataEntreDate) {
		this.dataEntreDate = dataEntreDate;
	}
